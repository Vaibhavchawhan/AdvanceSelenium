...
//	protected WebDriver driver;
	...
	public void OrganigationTest() throws IOException, InterruptedException {
		...
		/*
		 * WebDriver driver = new ChromeDriver(); wutil.maximize(driver);
		 * wutil.implicitlywait(driver);
		 * 
		 * // To Read the Data From Properties File String URL =
		 * putil.getDataFromPropertyFile("Url");
		 */
		/*
		 * String USERNAME = putil.getDataFromPropertyFile("Username"); String PASSWORD
		 * = putil.getDataFromPropertyFile("Password");
		 */
...
// To launch the Application
		...
		/*
		 * // Mousehover on Image Thread.sleep(2000); WebElement image =
		 * driver.findElement(By.cssSelector("img[src='themes/softed/images/user.PNG']")
		 * ); wutil.mousehover(driver, image);
		 * 
		 * // sign out driver.findElement(By.xpath("//a[text()='Sign Out']")).click();
		 */
	}
